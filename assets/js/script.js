(() => {
  ...
  const translations = {
    da: {
      ...
      'about.bio3': 'Udover mit studie engagerer jeg mig i frivilligt arbejde på flere områder, herunder app-udvikling og ansvar for en forenings hjemmeside.',
      'about.bio4': 'Derudover kan jeg godt lide at komme ud og rejse og se andre kulturer og seværdigheder.',
      'about.skillsLabel': 'Teknologier & Værktøjer',

      'exp.label': 'Sektion 02', 'exp.title': 'Erfaring',
      'exp.date1': '2024 — 2026', 'exp.role1': 'Tutor',
      ...
      'exp.desc4': 'Kørsel af mad ud til ældre borgere i Varde-området. Lærte at planlægge ruter, kommunikere med mange slags mennesker og møde op til tiden.',
    ...
    en: {
      ...
      'about.bio3': 'Alongside my studies, I engage in voluntary work in several areas, including app development and managing a club\'s website.',
      'about.bio4': 'I also enjoy travelling and seeing other cultures and places.',
      ...
      'exp.place4': 'Hotel Outrup · Esbjerg',
      'exp.desc4': 'Food delivery to elderly residents around Varde. Learned route planning, talking to all kinds of people, and showing up on time.',
    ...
    de: {
      ...
      'about.bio3': 'Neben meinem Studium engagiere ich mich ehrenamtlich in verschiedenen Bereichen, darunter App-Entwicklung und die Betreuung einer Vereinswebsite.',
      'about.bio4': 'Außerdem reise ich gerne und lerne andere Kulturen und Sehenswürdigkeiten kennen.',
      ...
      'exp.place4': 'Hotel Outrup · Esbjerg',
      'exp.desc4': 'Essenslieferung an ältere Bewohner im Raum Varde. Routenplanung, Kommunikation mit verschiedenen Menschen und Zuverlässigkeit.',
